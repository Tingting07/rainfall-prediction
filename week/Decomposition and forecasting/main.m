...
tempLayers = [
    ...
    %selfAttentionLayer(f_, 90,"Name","selfattention") 
...
[   pcc1,R21,mae5,rmse5,mape5,error5]=calc_error(T_train5,T_sim5);
fprintf('\n')

disp('Testing set error metrics')
[pcc2,R22,mae6,rmse6,mape6,error6]=calc_error(T_test6,T_sim6);
fprintf('\n')
